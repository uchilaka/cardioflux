angular.module('svc.ext', [])
        .factory('$extendService', ['$http', '$rootScope', '$location', function ($http, $rt, $urloc) {
                var options = {
                    namespace: 'APPLOG',
                    verbose: true
                };
                ...
                engn.log('[service.extendService]');
                return engn;
            }]);
